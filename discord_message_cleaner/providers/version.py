...
def create_version_file():
    ...
    version_info = [
        ...
        "        StringStruct(u'FileDescription', u'DiscordMessageCleaner'),",
        "        StringStruct(u'FileVersion', u'" + str(int(version_split[0])) + "." + str(
            int(version_split[1])) + "." + str(int(version_split[2])) + "." + str(int(suffix)) + "'),",
        "        StringStruct(u'InternalName', u'DiscordMessageCleaner'),",
        "        StringStruct(u'LegalCopyright', u'Copyright © RiX'),",
        "        StringStruct(u'OriginalFilename', u'DiscordMessageCleaner.exe'),",
        "        StringStruct(u'ProductName', u'DiscordMessageCleaner'),",
